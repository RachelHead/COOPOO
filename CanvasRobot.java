...
public class CanvasRobot
{
    ...
    private Colour colourLeg = Colour.BLACK;
    ...
    //AJOUTS POUR ROBOT DISCO
    public void setColourHead(Colour coul){
        colourHead = coul;
    }
    public void setColourBody(Colour coul){
        colourBody = coul;
    }
    public void setColourLeg(Colour coul){
        colourLeg = coul;
    }
    public void setColourEye(Colour coul){
        colourEye = coul;
    }
